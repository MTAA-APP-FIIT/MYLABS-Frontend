// import { StyleSheet, Text, View, Video } from 'react-native';
...
//   const [camera, setCamera] = useState({videoUrl: null, isFront: true});
//   // console.log(userId)
...
//         if(sourceInfo.kind === "videoinput" && sourceInfo.facing === (camera.isFront ? "front" : "environment")) {
...
//           height: 480,
//           frameRate: 30,
//           facingMode: (camera.isFront ? "user" : "environment"),
//           deviceId: videoSourceId
//         }
//       })
//       .then(stream => {
//         // console.log('Streaming OK', stream);
//         setCamera({...camera, videoUrl: stream.toURL()})
//         pc.addStream(stream);
//       })
//       .catch(error => {
//         console.log(error);
...
//   return (
//     <RTCView streamURL={camera.videoUrl} objectFit={'cover'}/>
//   )
// }
